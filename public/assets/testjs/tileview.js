Ext.Loader.setConfig({
	...
	paths: {
		...
		'Ext.ux.grid': base_url+'public/extjs/examples/ux/grid',
		'Ext.ux.grid.feature': base_url+'public/extjs/examples/ux/grid/feature',
		'Ext.ux.container': base_url+'public/extjs/examples/ux/container'
	}
});
