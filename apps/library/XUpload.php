 ...
 * 文件上传
 * 
 * @author        kim <837633677@qq.com>
 * @copyright     Copyright (c) 2007-2013 bagesoft. All rights reserved.
 * @link          http://www.iqilong.com
 * @package       KIM
 * @license       http://www.iqilong.com/license
 * @version       v3.1.0
 */
class XUpload {
    ...
    private function _saveRule( $params = array( 'rule'=>'default', 'format'=>'Ymd' ) ) {
        ...
        return PUBLIC_ROOT.'/uploads/' . $path;
    }
     ...
     */
    static public function upload( $fileFields, $params = array( 'thumb'=>true, 'thumbSize' => array( 100, 100 ), 'allowExts' => 'jpg,gif,png,jpeg', 'maxSize' => 3292200 ) ) {
        require_once LIBRARY_DIR.'XUPload/UploadFile.class.php';
