...
require_once PHPPOWERPOINT_BASE_PATH . 'PHPPowerPoint/Writer/PowerPoint2007.php';
...
/** PHPPowerPoint_Shape */
require_once PHPPOWERPOINT_BASE_PATH . 'PHPPowerPoint/Shape.php';

/** PHPPowerPoint_Shape_RichText */
require_once PHPPOWERPOINT_BASE_PATH . 'PHPPowerPoint/Shape/RichText.php';

/** PHPPowerPoint_Shape_BaseDrawing */
require_once PHPPOWERPOINT_BASE_PATH . 'PHPPowerPoint/Shape/BaseDrawing.php';

/** PHPPowerPoint_Shape_Drawing */
require_once PHPPOWERPOINT_BASE_PATH . 'PHPPowerPoint/Shape/Drawing.php';

/** PHPPowerPoint_Shape_MemoryDrawing */
require_once PHPPOWERPOINT_BASE_PATH . 'PHPPowerPoint/Shape/MemoryDrawing.php';

/** PHPPowerPoint_Shared_Font */
require_once PHPPOWERPOINT_BASE_PATH . 'PHPPowerPoint/Shared/Font.php';

/** PHPPowerPoint_Shared_String */
require_once PHPPOWERPOINT_BASE_PATH . 'PHPPowerPoint/Shared/String.php';
