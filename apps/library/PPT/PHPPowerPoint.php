...
/** PHPWORD_BASE_PATH */
if(!defined('PHPPOWERPOINT_BASE_PATH')) {
    define('PHPPOWERPOINT_BASE_PATH', dirname(__FILE__) . '/');
    require PHPPOWERPOINT_BASE_PATH . 'PHPPowerPoint/Autoloader.php';
    require PHPPOWERPOINT_BASE_PATH . 'PHPPowerPoint/IOFactory.php';
...
require_once PHPPOWERPOINT_BASE_PATH . 'PHPPowerPoint/DocumentProperties.php';

/** PHPPowerPoint_Shared_ZipStreamWrapper */
require_once PHPPOWERPOINT_BASE_PATH . 'PHPPowerPoint/Shared/ZipStreamWrapper.php';

/** PHPPowerPoint_SlideIterator */
require_once PHPPOWERPOINT_BASE_PATH . 'PHPPowerPoint/SlideIterator.php';
